...
git clone -b feature/add_vel_primitives git@github.com:stlucas44/asv_mppi.git
git clone -b fix/ubuntu20.04 git@github.com:stlucas44/roboat_social_simulator.git
git clone git@github.com:stlucas44/spline.git
